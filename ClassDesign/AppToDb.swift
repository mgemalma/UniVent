...
func insertUser(user1: User) {
    ...
    let stringURL = "https://gymbuddyapp.net/insertUser.php?userID=\(user1.getUserID())&userName=\(user1.getUserName())&flagCount=\(user1.getUserHistory().getFlagCount())&postedEvents=Sprint2Lol&attendingEvents=Sprint2Too&interests=0&schedule=Sprint2&deviceID=q324as5d6fty"
