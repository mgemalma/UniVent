...
class TimeInfo {
    ...
    func getCreatedTimeStamp() -> Double {return cTime.timeIntervalSince1970}
    func getStartTimeStamp() -> Double {return sTime.timeIntervalSince1970}
    func getEndTimeStand() -> Double {return eTime.timeIntervalSince1970}
